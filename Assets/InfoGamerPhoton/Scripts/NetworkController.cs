...
public class NetworkController : MonoBehaviourPunCallbacks
{
    ...
    * ******************************************************/
    ...
    {
        PhotonNetwork.AuthValues.UserId = "name"+Random.Range(0,1000);
        Debug.Log("We are now connected to the " + PhotonNetwork.CloudRegion + " server!"+ PhotonNetwork.AuthValues.UserId +","+PhotonNetwork.ServerAddress+","+PhotonNetwork.Server);
    }
}
